    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{ asset('admin/order') }}">
          <i class="fas fa-fw fa-money-bill-alt"></i> <span>Orders</span></a>
      </li>
      <!-- PRODUK -->
      <hr class="sidebar-divider">
      <div class="sidebar-heading">Service &amp; Product</div>
      <hr class="sidebar-divider">
      <li class="nav-item">
        <a class="nav-link" href="{{ asset('admin/services') }}">
          <i class="fas fa-fw fa-book"></i> <span>Services</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="{{ asset('admin/product') }}">
          <i class="fas fa-fw fa-book"></i> <span>Products</span></a>
      </li>
     <!--  <li class="nav-item">
      ...
      <!-- Berita -->
       <li class="nav-item">
        <a class="nav-link" href="{{ asset('admin/pages') }}">
          <i class="fa fa-fw fa-lock"></i> <span>Pages</span></a>
      </li>
        <li class="nav-item">
        <a class="nav-link" href="{{ asset('admin/faq') }}">
          <i class="fa fa-fw fa-lock"></i> <span>FAQ</span></a>
      </li>
        <li class="nav-item">
        <a class="nav-link" href="{{ asset('admin/contacts') }}">
          <i class="fa fa-fw fa-lock"></i> <span>Contacts</span></a>
      </li>
     ...
     <!--  <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{ asset('admin/user') }}">
          <i class="fa fa-fw fa-lock"></i> <span>Users</span></a>
      </li>
      <!-- Konfigurasi -->
      <li class="nav-item">
        ...
        <div id="Konfigurasi" class="collapse" aria-labelledby="Konfigurasi" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{ asset('admin/konfigurasi/logo') }}"><i class="fa fa-image"></i> Logo</a>
            <a class="collapse-item" href="{{ asset('admin/konfigurasi/icon') }}"><i class="fa fa-tree"></i> Icon</a>
