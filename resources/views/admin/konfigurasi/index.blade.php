...
<div class="col-md-6">
    ...
    <div class="form-group">
        ...
        <input type="text" name="currency" placeholder="$ / Rp." value="<?php echo $site->currency ?>" class="form-control">
    </div>

    <div class="form-group">
        <label>Currency Name</label>
        <input type="text" name="currency_name" placeholder="USD / Rupiah" value="<?php echo $site->currency_name ?>" class="form-control">
    </div>
...
<div class="col-md-6">
   ...
   <input type="text" name="instagram" placeholder="http://instagram.com/namakamu" value="<?php echo $site->instagram ?>" class="form-control">
	...
	<h3>SEO (Search Engine Optimization)</h3><hr>
	<div class="form-group">
